...
public class CreateOrderHandler(IApplicationContext dbContext) : ICommandHandler<CreateOrderCommand, CreateOrderResult>
{
    ...
    private Order CreateNewOrder(OrderDto orderDto)
    {
        ...
        {
            newOrder.AddProduct(ProductId.Of(orderItemDto.ProductId), orderItemDto.Quantity, orderItemDto.Price);
        }
        return newOrder;
    }
}
