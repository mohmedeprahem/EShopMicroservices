    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            ...
            var order1 = Order.Create(
                            ...
                            payment1);
            order1.AddProduct(ProductId.Of(new Guid("5334c996-8457-4cf0-815c-ed2b77c4ff61")), 2, 500);
            order1.AddProduct(ProductId.Of(new Guid("c67d6323-e8b1-4bdf-9a75-b0d0d2e7e914")), 1, 400);
            ...
            var order2 = Order.Create(
                            ...
                            payment2);
            order2.AddProduct(ProductId.Of(new Guid("4f136e9f-ff8c-4c1f-9a33-d12f689bdab8")), 1, 650);
            order2.AddProduct(ProductId.Of(new Guid("6ec1297b-ec0a-4aa1-be25-6726e3b51a27")), 2, 450);
